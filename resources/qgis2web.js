...
map.getView().fit([13716379.474049, 821554.098388, 14124456.930108, 1043497.319798], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WAREHOUSE MAP IN REGION 10</h2>';
        return titleElement;
    })(),
